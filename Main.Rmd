...
- **`Year`**  
  ...
  - **Descripción**: Año en que se registraron los datos, útil para análisis temporales y de tendencias.  
...
- **`Soil_Health_Index`**  
  - **Tipo**: Numérica continua  
  - **Descripción**: Índice que evalúa la calidad y salud del suelo, un factor importante en el rendimiento agrícola sostenible.  
...
- **`Economic_Impact_Million_USD`**  
  - **Tipo**: Numérica continua  
  - **Descripción**: Impacto económico estimado en millones de dólares, útil para evaluar las implicaciones económicas de los factores climáticos.  
...
Boxplot de `Crop_Yield_MT_per_HA`
...
Boxplot de `Average_Temperature_C`
```{r boxplot-temp}
...
Boxplot de `Total_Precipitation_mm`
...
Boxplot de `Extreme_Weather_Events`
...
Boxplot de `Pesticide_Use_KG_per_HA`
```{r boxplot-pesticide}
...
Boxplot de `Fertilizer_Use_KG_per_HA`
...
Boxplot de `Economic_Impact_Million_USD`
